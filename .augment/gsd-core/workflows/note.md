...
- **Global scope**: `/home/reisfelipe18/Repos/sure/.augment/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/reisfelipe18/Repos/sure/.augment/notes/`)
...
2. Glob `/home/reisfelipe18/Repos/sure/.augment/notes/*.md` (if directory exists) — global notes
...
Global (/home/reisfelipe18/Repos/sure/.augment/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/reisfelipe18/Repos/sure/.augment/notes/` — works in any directory
