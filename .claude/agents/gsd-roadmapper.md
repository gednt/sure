...
Reference full template: `/home/reisfelipe18/Repos/sure/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/reisfelipe18/Repos/sure/.claude/gsd-core/templates/state.md`.
