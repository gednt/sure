...
<!-- For checkpoint task examples and patterns, see @/home/reisfelipe18/Repos/sure/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/reisfelipe18/Repos/sure/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/reisfelipe18/Repos/sure/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/reisfelipe18/Repos/sure/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
