...
ones). Reference: @/home/reisfelipe18/Repos/sure/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/reisfelipe18/Repos/sure/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/reisfelipe18/Repos/sure/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/reisfelipe18/Repos/sure/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/reisfelipe18/Repos/sure/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/reisfelipe18/Repos/sure/.claude/gsd-core/templates/spec.md.
