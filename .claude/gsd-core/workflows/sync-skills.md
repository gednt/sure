...
INSTALL_JS_GLOBAL="/home/reisfelipe18/Repos/sure/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/reisfelipe18/Repos/sure/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
