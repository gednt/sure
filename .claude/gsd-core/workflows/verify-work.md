...
<template>
@/home/reisfelipe18/Repos/sure/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/reisfelipe18/Repos/sure/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/reisfelipe18/Repos/sure/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/reisfelipe18/Repos/sure/.claude/gsd-core/workflows/diagnose-issues.md
