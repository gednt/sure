...
---
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/reisfelipe18/Repos/sure/.codebuddy/.gsd-surface.json`
(sibling to `/home/reisfelipe18/Repos/sure/.codebuddy/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/reisfelipe18/Repos/sure/.codebuddy/skills/gsd-*/`.
...
(`/home/reisfelipe18/Repos/sure/.codebuddy`), NOT the skills sub-directory (`/home/reisfelipe18/Repos/sure/.codebuddy/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/reisfelipe18/Repos/sure/.codebuddy` as `configDir`. The skill dirs themselves live at
`/home/reisfelipe18/Repos/sure/.codebuddy/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# CodeBuddy — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/reisfelipe18/Repos/sure/.codebuddy}"
SCOPE="global"
...
(i.e. `/home/reisfelipe18/Repos/sure/.codebuddy/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/reisfelipe18/Repos/sure/.codebuddy/.gsd-surface.json`
Install profile marker: `/home/reisfelipe18/Repos/sure/.codebuddy/.gsd-profile`
Skill dirs: `/home/reisfelipe18/Repos/sure/.codebuddy/skills/gsd-*/`
Engine module: `/home/reisfelipe18/Repos/sure/.codebuddy/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/reisfelipe18/Repos/sure/.codebuddy/gsd-core/bin/lib/clusters.cjs`
</execution_context>
