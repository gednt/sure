...
**Test:** Could a different Claude instance execute without asking clarifying questions? If not, add specificity. See @/home/reisfelipe18/Repos/sure/.cursor/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.
