...
```markdown
Read /home/reisfelipe18/Repos/sure/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/reisfelipe18/Repos/sure/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/reisfelipe18/Repos/sure/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/reisfelipe18/Repos/sure/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/reisfelipe18/Repos/sure/.cursor/agents/gsd-eval-planner.md for instructions.
