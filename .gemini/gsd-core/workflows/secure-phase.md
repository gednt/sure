...
```
Agent(
  prompt="Read /home/reisfelipe18/Repos/sure/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/reisfelipe18/Repos/sure/.gemini/gsd-core/templates/SECURITY.md`
