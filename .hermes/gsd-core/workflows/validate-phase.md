...
```
Agent(
  prompt="Read /home/reisfelipe18/Repos/sure/.hermes/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/reisfelipe18/Repos/sure/.hermes/gsd-core/templates/VALIDATION.md`
