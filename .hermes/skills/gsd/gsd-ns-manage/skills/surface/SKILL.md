...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/reisfelipe18/Repos/sure/.hermes/.gsd-surface.json`
(sibling to `/home/reisfelipe18/Repos/sure/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/reisfelipe18/Repos/sure/.hermes/skills/gsd-*/`.
...
(`/home/reisfelipe18/Repos/sure/.hermes`), NOT the skills sub-directory (`/home/reisfelipe18/Repos/sure/.hermes/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/reisfelipe18/Repos/sure/.hermes` as `configDir`. The skill dirs themselves live at
`/home/reisfelipe18/Repos/sure/.hermes/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Hermes Agent — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/reisfelipe18/Repos/sure/.hermes}"
SCOPE="global"
...
(i.e. `/home/reisfelipe18/Repos/sure/.hermes/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/reisfelipe18/Repos/sure/.hermes/.gsd-surface.json`
Install profile marker: `/home/reisfelipe18/Repos/sure/.hermes/.gsd-profile`
Skill dirs: `/home/reisfelipe18/Repos/sure/.hermes/skills/gsd-*/`
Engine module: `/home/reisfelipe18/Repos/sure/.hermes/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/reisfelipe18/Repos/sure/.hermes/gsd-core/bin/lib/clusters.cjs`
</execution_context>
