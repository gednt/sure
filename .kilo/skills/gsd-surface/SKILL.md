...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/reisfelipe18/Repos/sure/.kilo/.gsd-surface.json`
(sibling to `/home/reisfelipe18/Repos/sure/.kilo/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/reisfelipe18/Repos/sure/.kilo/skills/gsd-*/`.
...
(`~/.config/kilo`), NOT the skills sub-directory (`/home/reisfelipe18/Repos/sure/.kilo/skills`).
...
`/home/reisfelipe18/Repos/sure/.kilo/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/reisfelipe18/Repos/sure/.kilo/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/reisfelipe18/Repos/sure/.kilo/.gsd-surface.json`
Install profile marker: `/home/reisfelipe18/Repos/sure/.kilo/.gsd-profile`
Skill dirs: `/home/reisfelipe18/Repos/sure/.kilo/skills/gsd-*/`
Engine module: `/home/reisfelipe18/Repos/sure/.kilo/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/reisfelipe18/Repos/sure/.kilo/gsd-core/bin/lib/clusters.cjs`
</execution_context>
