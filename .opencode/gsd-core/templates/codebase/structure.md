...
- Usage: Reference from command with `@/home/reisfelipe18/Repos/sure/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/reisfelipe18/Repos/sure/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/reisfelipe18/Repos/sure/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
