...
<required_reading>
@/home/reisfelipe18/Repos/sure/.opencode/gsd-core/references/ai-frameworks.md
@/home/reisfelipe18/Repos/sure/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/reisfelipe18/Repos/sure/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/reisfelipe18/Repos/sure/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/reisfelipe18/Repos/sure/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/reisfelipe18/Repos/sure/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/reisfelipe18/Repos/sure/.opencode/agents/gsd-eval-planner.md for instructions.
