...
function evaluateWorktreeBaseDegrade(deps) {
    ...
    // Trae's worktree.baseRef accepts only "fresh" (= origin/HEAD, the default) or "head".
    ...
    // semantics and must be evaluated against origin/HEAD. (Reference: Trae worktrees docs, #683.)
