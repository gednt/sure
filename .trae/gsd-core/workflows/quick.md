...
- .trae/rules/ or ./.trae/.trae/rules/ (if exists — project-specific guidelines)
...
- .trae/rules/ or ./.trae/.trae/rules/ (if exists — follow project-specific guidelines)
...
- .planning/STATE.md (Project state)
- .trae/rules/ or ./.trae/.trae/rules/ (Project instructions, if exists)
