...
```
Agent(
  prompt="Read /home/reisfelipe18/Repos/sure/.trae/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/reisfelipe18/Repos/sure/.trae/gsd-core/templates/SECURITY.md`
