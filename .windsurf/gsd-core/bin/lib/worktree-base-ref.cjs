...
function evaluateWorktreeBaseDegrade(deps) {
    ...
    // Windsurf's worktree.baseRef accepts only "fresh" (= origin/HEAD, the default) or "head".
    ...
    // semantics and must be evaluated against origin/HEAD. (Reference: Windsurf worktrees docs, #683.)
