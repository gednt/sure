...
<required_reading>
@/home/reisfelipe18/Repos/sure/.windsurf/gsd-core/references/user-story-template.md
@/home/reisfelipe18/Repos/sure/.windsurf/gsd-core/references/spidr-splitting.md
@/home/reisfelipe18/Repos/sure/.windsurf/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/reisfelipe18/Repos/sure/.windsurf/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/reisfelipe18/Repos/sure/.windsurf/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/reisfelipe18/Repos/sure/.windsurf/gsd-core/references/spidr-splitting.md`. Briefly:
